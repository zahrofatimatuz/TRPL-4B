 ...
 * @author rkhis
 */
public class KorbanGempaView extends javax.swing.JFrame {

    /**
     * Creates new form KorbanGempaView
     */
    ...
    public void setOk_button(JButton ok_button) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(ok_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 370, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/PopUp/PoPupGempa-1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KorbanGempaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KorbanGempaView().setVisible(true);
            }
        });
    }
